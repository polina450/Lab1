...
graph TD
    ...
    B --> C{A < X?}
    C -- Да --> C1[/count = count + 1/]
    C -- Нет --> C2[/Вывод count/]
    C2 --> Z([Конец])
    C1 --> D{B < X?}
    D -- Да --> D1[/count = count + 1/]
    D -- Нет --> D2[/Вывод count/]
    D2 --> Z
    D1 --> E{C < X?}
    E -- Да --> E1[/count = count + 1/]
    E -- Нет --> E2[/Вывод count/]
    E2 --> Z
    E1 --> F{D < X?}
    F -- Да --> F1[/count = count + 1/]
    F -- Нет --> F2[/Вывод count/]
    F2 --> Z
    F1 --> G[/Вывод count/]
    G --> Z
```
